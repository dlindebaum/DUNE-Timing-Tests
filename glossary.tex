...
% FPGA Mezzanine card
\newduneabbrev{fmc}{FMC}{FPGA Mezzanine Card} {An ANSI/VITA (VMEbus International Trade Association) 57.1 standard that defines I/O mezzanine modules with connection to an FPGA.}
